  ...
  return knex('stores').del()
    .then(function () {
      ...
      return knex('stores').insert([
        ...
        { name: 'Presto Usaquén', phone_number: '123456', address: 'Cra. 7 #116A-92', address_details: '', latitude: 4.692575, longitude: -74.033215, photo: 'https://images.rappi.com/restaurants_background/900016763-1532637398f.png' },
